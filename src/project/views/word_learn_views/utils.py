...
class GameLevel(int, Enum):
    ...
    LEVEL_4 = 4, 12.0, '✍️ Прослушай аудио и введи верное слово'
    ...
    LEVEL_5 = 5, 13.0, '✍️ ВВЕДИ верный перевод предложения'
    ...
    # прослушать и ввести правильный вариант
    LEVEL_6 = 6, 14.0, '✍️ Прослушай аудио и введи верное предложение'
    LAST_LEVEL = 7, 15.0, '✍️ ВВЕДИ верный перевод'  # Фиктивный уровень только для верхней планки рейтинга
    ...
    def get_weights(cls, rating: float) -> list[float]:
        ...
        elif GameLevel.LEVEL_4.min_rating <= rating <= GameLevel.LEVEL_5.min_rating:
            weights[4] = rating / GameLevel.LEVEL_5.min_rating
            weights[3] = 1 - weights[3]
        elif GameLevel.LEVEL_5.min_rating <= rating:
            weights[5] = 0.25
            weights[4] = 0.25
            weights[3] = 0.25
            weights[2] = 0.25
