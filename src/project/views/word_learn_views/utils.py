...
class GameLevel(int, Enum):
    ...
    LEVEL_1 = 1, 3.0, '👇 ВЫБЕРИ верный перевод'
    ...
    LEVEL_2 = 2, 6.0, '✍️ Найди и ВВЕДИ верный перевод'
    ...
    LEVEL_3 = 3, 9.0, '✍️ ВВЕДИ верный перевод'
    ...
    async def sub_rating(self, words: 'UserWordModelManager') -> None:
        min_rating = 0
        await words.update_many([{'$set': {'rating': {'$max': [min_rating, {'$add': ['$rating', -1]}]}}}])
